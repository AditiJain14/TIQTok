...
@register_criterion("label_smoothed_cross_entropy_js")
class LabelSmoothedCrossEntropyJSCriterion(LabelSmoothedCrossEntropyCriterion):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--js_alpha', default=1, type=int, 
                            help='alpha hyperparameter for JS loss for CipherDAug')
        parser.add_argument('--js_warmup', default=1, type=int, 
                            help='WarmUp model with regular x-ent for this many updates before computing JS loss')
