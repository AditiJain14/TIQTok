...
class SequenceGeneratorLM(nn.Module):
    def __init__(
        self,
        models,
        tgt_dict,
    ...
    def _generate(
        ...
        for step in range(max_len + 1):  # one extra step for EOS marker
            ...
            if eos_bbsz_idx.numel() > 0:
                ...
                # finalized_reads = reads.cpu().index_select(
        ...
        return finalized, finalized_rw, src_lens
...
class EnsembleModel(nn.Module):
    ...
    def forward_encoder(self, net_input: Dict[str, Tensor]):
        ...
        # return [model.back_encoder.forward_torchscript(net_input) for model in self.models]
        return None
    ...
    def forward_decoder(
        ...
        for i, model in enumerate(self.models):
            ...
            # decode each model
            if hasattr(model, "lm_decoder"):
                decoder_out = model.lm_decoder.forward(tokens, encoder_out=encoder_out)
...
class SequenceGeneratorWithAlignment(SequenceGeneratorLM):
    def __init__(
